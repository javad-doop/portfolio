...
export default function ExperienceSection() {
  return (
    <section className="bg-white text-[#0b1221] py-24 px-6 flex items-center md:px-20">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 max-w-6xl mx-auto w-full">
        
        {/* ستون چپ - Work Experience */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          viewport={{ once: true }}
          className="flex flex-col items-center md:items-end text-center md:text-right gap-8 justify-center"
        >
          ...
          <div className="flex flex-col gap-8 border-l-0 md:border-r border-gray-300 md:pr-6">
            <div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="flex flex-col items-center md:items-start text-center md:text-left gap-8 justify-center"
        >
